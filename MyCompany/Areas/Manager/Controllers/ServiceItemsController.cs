    ...
    public class ServiceItemsController : Controller
    {
        ...
        public IActionResult Edit(ServiceItem model, IFormFile titleImageFile)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction(nameof(ServiceItemsController.Index), nameof(ServiceItemsController).CutController());
            }
            return View(model);
        }
        ...
        {
            return View("ShowServiceItems" , dataManager.ServiceItems.GetServiceItems());
        }
    }
}